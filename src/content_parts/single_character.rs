...
pub fn single_backtick(input: Input) -> IResult<Input, Input> {
...
pub fn single_tilde(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("~").parse(input)?;
let (input, _) = not(tag("~")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_exclamation(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("!").parse(input)?;
let (input, _) = not(tag("!")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_at_sing(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("@").parse(input)?;
let (input, _) = not(tag("@")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_octothorpe(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("#").parse(input)?;
let (input, _) = not(tag("#")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_dollar_sign(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("$").parse(input)?;
let (input, _) = not(tag("$")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_percent_sign(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("%").parse(input)?;
let (input, _) = not(tag("%")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_caret(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("^").parse(input)?;
let (input, _) = not(tag("^")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_ampersand(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("&").parse(input)?;
let (input, _) = not(tag("&")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_astrisk(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("*").parse(input)?;
let (input, _) = not(tag("*")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_open_paren(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("(").parse(input)?;
let (input, _) = not(tag("(")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_close_paren(input: Input) -> IResult<Input, Input> {
let (input, result) = tag(")").parse(input)?;
let (input, _) = not(tag(")")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_open_curly_bracket(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("{").parse(input)?;
let (input, _) = not(tag("{")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_close_curly_bracket(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("}").parse(input)?;
let (input, _) = not(tag("}")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_open_bracket(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("[").parse(input)?;
let (input, _) = not(tag("[")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_close_bracket(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("]").parse(input)?;
let (input, _) = not(tag("]")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_less_than(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("<").parse(input)?;
let (input, _) = not(tag("<")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_greater_than(input: Input) -> IResult<Input, Input> {
let (input, result) = tag(">").parse(input)?;
let (input, _) = not(tag(">")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_colon(input: Input) -> IResult<Input, Input> {
let (input, result) = tag(":").parse(input)?;
let (input, _) = not(tag(":")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_pipe(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("|").parse(input)?;
let (input, _) = not(tag("|")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_underscore(input: Input) -> IResult<Input, Input> {
...
pub fn single_hyphen(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("-").parse(input)?;
let (input, _) = not(tag("-")).parse(input)?;
  Ok((input, result))
  }
...
pub fn single_equal_sign(input: Input) -> IResult<Input, Input> {
let (input, result) = tag("=").parse(input)?;
let (input, _) = not(tag("=")).parse(input)?;
  Ok((input, result))
  }
